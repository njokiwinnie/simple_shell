...
int (*get_builtin(char *command))(char **args, char **front)
{
	builtin_t funcs[] = {
		...
		{ "unsetenv", simple_shell_unsetenv },
		{ "cd", simple_shell_cd },
		{ "alias", shell_alias },
...
/**
 * simple_shell_exit - Causes normal process termination
...
/**
 * simple_shell_help - Displays information about
 *	simple_shell builtin commands.
 * @args: Arrays.
 * @front: pointers.
 *
