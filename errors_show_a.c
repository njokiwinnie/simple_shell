...
/**
 * error_env - Creates an error message for simple_shell errors.
...
/**
 * error_2_exit - Creates an error message for simple_shell_exit errors.
 * @args: An array of arguments passed to the command.
 *
 * Return: The error string.
 */
...
/**
 * error_2_cd - Creates an error message for simple_shell_cd errors.
 * @args: An array of arguments passed to the command.
 *
 * Return: The error string.
 */
