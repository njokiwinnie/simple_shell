...
/**
 * help_all - Displays all builtin simple shell commands.
 */
void help_all(void)
{
	char *msg = "Simple Shell\nThese commands are Buit-in for Simple Shell.\n";
...
/**
 * help_alias - Displays information on the
 *	simple shell builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - Displays information on simple shell builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays information on simple shell builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays information on simple shell builtin command 'help'.
 */
void help_help(void)
{
